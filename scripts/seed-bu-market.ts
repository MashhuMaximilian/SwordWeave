...
const SEED: SeedRow[] = [
  ...
  { name: "Direct Material Trigger", category: "TRIGGER_HOOK", buCost: 3,
    ...
    targetScope: { layer: "NARROW_FOCUS", value: "concrete physical actions (crossing a threshold, launching an attack, dropping an object)" } },
  { name: "Systemic Threshold Trigger", category: "TRIGGER_HOOK", buCost: 6,
    ...
    targetScope: { layer: "NARROW_FOCUS", value: "quantified parameter changes (energy signatures manifesting, vitality thresholds, zone entries)" } },
  { name: "Conditional Informational Trigger", category: "TRIGGER_HOOK", buCost: 12,
    ...
    targetScope: { layer: "NARROW_FOCUS", value: "abstract narrative conditions (a specific individual lying, an ally losing consciousness, hidden entities crossing boundaries)" } },
  { name: "Interceptive Causal Trigger", category: "TRIGGER_HOOK", buCost: 24,
    ...
    targetScope: { layer: "NARROW_FOCUS", value: "out-of-sequence interception before an incoming event fully resolves in reality" } },
  ...
  { name: "Dormant Trigger Hook", category: "TEMPORAL_CHRONOLOGICAL", buCost: 12,
    ...
    targetScope: { layer: "NARROW_FOCUS", value: "dormant catalyst-release at a planted spatial coordinate (until an environmental catalyst triggers the mine)" } },
