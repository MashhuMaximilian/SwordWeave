...
const sandboxNav = [
  { href: "/sandbox/grammar?build=primitive", label: "Primitives", icon: Boxes },
  { href: "/sandbox/grammar?build=effect", label: "Effects", icon: Sparkles },
  { href: "/sandbox/grammar?build=capability", label: "Capabilities", icon: Swords },
  { href: "/sandbox/blueprint?build=item", label: "Items", icon: Package },
  { href: "/sandbox/blueprint?build=template&kind=race", label: "Templates", icon: ScrollText },
            ...
            <div className="mt-auto border-t border-border px-5 py-4">
              <div className="rounded-md border border-border bg-panel p-3">
                ...
                <p className="mt-1 text-xs leading-5 text-muted-foreground">
                  Import and export live in Library, then spread to every
                  object type through one JSON envelope.
                </p>
              </div>
            </div>
          </aside>
