...
export const CANONICAL_EXPRESSIONS:readonly CanonicalExpressionDefinition[] = [
  ...
  {key:"die-d4",name:"Minor Die Block",familyKey:"INTENSITY_DICE",category:"INTENSITY_DICE",tier:0,buCost:0,mechanicalText:"Unlock [1d4] damage or healing output.",rule:{family:"DICE",bindings:{dice:"1d4"}},verboseDescription:"Use a d4 for the baseline damage or healing output available without added BU cost. The parent capability still determines the action, target, source, and delivery rules."},
